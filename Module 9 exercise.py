...
# Lambda function to solve the slope or y-intercept of linear functions
# Slope: (y2 - y1) / (x2 - x1)
slope = lambda x1, y1, x2, y2: (y2 - y1) / (x2 - x1) if x1 != x2 else 'undefined'
...
print(y_intercept(1, 2, 1))  # Output: 1
